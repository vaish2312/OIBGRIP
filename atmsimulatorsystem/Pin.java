...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(String pin){
        ...
        l1.setBounds(280,200,800,35);
        l4.add(l1);
        
        l2.setBounds(250,270,150,35);
        l4.add(l2);
        
        l3.setBounds(250,300,200,35);
        l4.add(l3);
        
        t1.setBounds(390,270,140,25);
        l4.add(t1);
        
        t2.setBounds(390,300,140,25);
        l4.add(t2);
        
        b1.setBounds(380,380,150,35);
        l4.add(b1);
        
        b2.setBounds(380,420,150,35);
        l4.add(b2);
